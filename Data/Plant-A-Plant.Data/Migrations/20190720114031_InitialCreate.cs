        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    PestTypeId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescription = table.Column<string>(nullable: true),
                    LongDescription = table.Column<string>(nullable: true),
                    EstimatedTimeForGrowing = table.Column<TimeSpan>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisterActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegisterActivities_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PestsPlants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PestsPlants_Pests_PestId",
                        column: x => x.PestId,
                        principalTable: "Pests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PestsPlants_Plants_PlantId",
                        column: x => x.PlantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PestsPlants_PestId",
                table: "PestsPlants",
                column: "PestId");

            migrationBuilder.CreateIndex(
                name: "IX_PestsPlants_PlantId",
                table: "PestsPlants",
                column: "PlantId");

            migrationBuilder.CreateIndex(
                name: "IX_Plants_EventId",
                table: "Plants",
                column: "EventId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegisterActivities_FieldId",
